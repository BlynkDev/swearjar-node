...
const violentWords = require('./config/violent_words')
const sexualWords = require('./config/sexual_words')
const drugs = require('./config/drugs')
  ...
  setLang(lang = "en") {
    switch (lang) {
      ...
      case "id":
        ...
        break;
      case "en":
        en.simple = Object.assign(en.simple, violentWords, sexualWords, drugs);
